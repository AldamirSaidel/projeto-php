...
$animais_detalhes = [
    ...
    'gato' => [
        'nome' => 'Gato',
        'caracteristicas' => [
            ['gosta de leite', 'gato/leite.jpg'],
            ['Gosta de correr atrás de  rato', 'gato/rato.png']
        ]
        ],
    'peixe' => [
        'nome' => 'Peixe',
        'caracteristicas' => [
            ['Gosto de agua', 'peixe/agua.jpg'],
            ['Posso morar aqui', 'peixe/aquario.jpg']
        ]
    ]
];
...
while ($escolha_aleatoria == $animal_x ){
    $animal_x = rand(0,count($animais)-1);
    }
    ...
    <body>
        ...
        <div class="container-fluid p-2 mt-3" style="background: lightgreen">
            <div class="row">
                ...
                <div class="col-md-3">
                    <a href="votar.php?apresentado=<?=$animais[$escolha_aleatoria]?>&escolhido=<?=$animais[$animal_x]?>">
                    <img width="256" src="./imagens/<?=$animais[$animal_x ]?>.png" class="img-fluid" alt="caracteristicas" />
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="votar.php?apresentado=<?=$animais[$escolha_aleatoria]?>&escolhido=<?=$animais[$escolha_aleatoria]?>" >
                        <!-- deixe dinâmico esta imagem abaixo -->
                            <img width="256" src="./imagens/<?=$animais[$escolha_aleatoria]?>.png" class="img-fluid" alt="caracteristicas" />
                    </a>
                </div>
                <div class="col-md-3"></div> 
            </div>
